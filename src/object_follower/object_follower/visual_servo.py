...
class VisualServoController:
    ...
    def compute_control(self, bbox: Tuple[int, int, int, int],
        ...
        if self._state.ratio_ema < self._target_ratio and path_clear:
            ...
            # CRITICAL FIX: Enforce minimum velocity to overcome Gazebo friction
            # Without this, velocities < 0.05 m/s won't actually move the robot
            MIN_LIN_VEL = 0.10  # Minimum velocity floor
            if lin > 0.01:  # Only enforce floor if we want to move
